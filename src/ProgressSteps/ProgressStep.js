...
class ProgressStep extends Component {
  onNextStep = async () => {
    this.props.onNext && (await this.props.onNext(this.props.activeStep));
  ...
  onPreviousStep = () => {
    ...
    this.props.onPrevious && this.props.onPrevious(this.props.activeStep);
    this.props.setActiveStep(this.props.activeStep - 1);
  };

  onSubmit = () => {
    this.props.onSubmit && this.props.onSubmit(this.props.activeStep);
  };
